...
<body>
  ...
  <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main report-shell">
    ...
    <div class="row">
      ...
      <div class="col-sm-4"><div class="report-block metric-card"><p class="metric-label">Months</p><h3 class="metric-value"><?php echo $recordCount; ?></h3></div></div>
      <div class="col-sm-4"><div class="report-block metric-card"><p class="metric-label">Highest Month</p><h3 class="metric-value"><?php echo report_money($topPeriodValue, $currency); ?></h3><p class="report-subtitle"><?php echo $topPeriodLabel; ?></p></div></div>
    </div>
