  ...
  <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main report-shell">
    <div class="report-card">
      <div class="report-card-head">
        <h1>Daily report</h1>
        <p>Choose a date range and currency to see daily grouped spending.</p>
      </div>
      <div class="report-card-body">
        <form class="report-form" method="post" action="expense-datewise-reports-detailed.php">
          <div class="row">
            <div class="col-md-4">
              <div class="form-group">
                <label for="fromdate">From date</label>
                <input class="form-control" type="date" id="fromdate" name="fromdate" required value="<?php echo date('Y-m-01'); ?>">
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
                <label for="todate">To date</label>
                <input class="form-control" type="date" id="todate" name="todate" required value="<?php echo date('Y-m-d'); ?>">
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
        ...
        <div class="quick-note">
          Best for checking day-by-day changes, spikes, and recent spending patterns.
        </div>
      </div>
    </div>
  </div>
